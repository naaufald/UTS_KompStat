...
st.header("flowchart")
st.image("https://raw.githubusercontent.com/naaufald/UTS_KompStat/main/flowchart.png")

st.header("Data : dataset yang digunakan merupakan data saham selama rentang 2015-2016")
st.image("https://raw.githubusercontent.com/naaufald/UTS_KompStat/main/dataa.png", caption = "Sumber Data: https://www.kaggle.com/code/bturan19/financial-time-series-monte-carlo-simulation-arma/input")
st.markdown(""" 
...
st.image("https://raw.githubusercontent.com/naaufald/UTS_KompStat/main/sum_strdata.png")
...
st.markdown(kode_r)
st.image("https://raw.githubusercontent.com/naaufald/UTS_KompStat/main/MV.png")
...
st.markdown(kode_r)
st.image("https://raw.githubusercontent.com/naaufald/UTS_KompStat/main/outlier.png")
...
st.markdown(kode_r)
st.image("https://raw.githubusercontent.com/naaufald/UTS_KompStat/main/visualisasi.png")
...
st.markdown(kode_r)
st.image("https://raw.githubusercontent.com/naaufald/UTS_KompStat/main/FE.png")
st.markdown("""
...
ggplot(data_sim, aes(x = time_horizon)) +
  ...
  theme_minimal()"""
st.markdown(kode_r)
st.image("https://raw.githubusercontent.com/naaufald/UTS_KompStat/main/visualisasi_dist.png")
...
print(markov_model)"""
st.markdown(kode_r)
st.image("https://raw.githubusercontent.com/naaufald/UTS_KompStat/main/markov.png")
...
ggplot(transition_df, aes(x = From, y = To, fill = Probability)) +
  ...
  theme_minimal()"""
st.markdown(kode_r)
st.image("https://raw.githubusercontent.com/naaufald/UTS_KompStat/main/visual_MC.png")
...
summary(hmm_fit)"""
st.markdown(kode_r)
st.image("https://raw.githubusercontent.com/naaufald/UTS_KompStat/main/HMM.png")
...
ggplot(data, aes(x = date, y = close, color = factor(HMM_State))) +
  ...
  theme_minimal()"""
st.markdown(kode_r)
st.image("https://raw.githubusercontent.com/naaufald/UTS_KompStat/main/HMM_states.png")
